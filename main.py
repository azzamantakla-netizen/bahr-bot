...
def start_cmd(message):
    ...
    global_bot.send_message(message.chat.id, "👋 لوحة الكاشير السحابية ذاتية التحديث بالملي نشطة حياً!", reply_markup=markup)
...
# تشغيل الـ Webhook المستقر تلقائياً في الخلفية عند الإقلاع
